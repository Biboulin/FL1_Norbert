...
class WalkthroughOld extends StatefulWidget {
  const WalkthroughOld(
    this.nbPage,
    this.mainText,
    this.secondaryText, {
    Key key,
  ...
  @override
  _WalkthroughOldState createState() => _WalkthroughOldState();
}

class _WalkthroughOldState extends State<WalkthroughOld> {
  @override
